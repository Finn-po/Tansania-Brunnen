...
const I18N = {
  de: {
    ...
    'update.1.date': 'In Planung',
    'update.1.title': 'Nachttrödel wird vorbereitet',
    'update.1.text': 'Der Nachttrödelmarkt ist als kommende Spendenaktion geplant. Sobald Termin und Ablauf feststehen, gibt es hier ein Update.',
  ...
  en: {
    ...
    'update.1.date': 'In planning',
    'update.1.title': 'Night flea market is being prepared',
    'update.1.text': 'The night flea market is planned as an upcoming fundraiser. As soon as the date and details are confirmed, there will be an update here.',
    'update.2.date': 'April 2025',
