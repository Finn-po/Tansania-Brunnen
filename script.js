...
const I18N = {
  de: {
    ...
    'hero.next_update': 'Nächstes Update: 10.07.2026',
    'floating.donate': 'Spenden',

    'story.eyebrow': 'Die Geschichte',
    'story.title.1': 'Kisangasa braucht',
    'story.title.2': 'eine verlässliche Wasserquelle.',
    'story.p1': 'Kisangasa ist ein Dorf in Tansania. Viele Familien dort haben keinen sicheren Zugang zu sauberem Wasser in unmittelbarer Nähe.',
    'story.p2': 'Gesicherte Angaben zur Einwohnerzahl und zur genauen Entfernung zur nächsten sicheren Wasserquelle werden noch mit den Ansprechpartner:innen vor Ort abgeglichen. Diese Informationen werden ergänzt, sobald sie belastbar vorliegen.',
    'story.p3': 'Der aktuelle Bedarf ist klar: Wasser muss über längere Wege geholt werden. Das kostet Zeit, belastet vor allem Kinder und Frauen und erhöht das Risiko, verunreinigtes Wasser zu nutzen.',
    'story.p4': 'Direkte Zitate von Bewohner:innen aus Kisangasa liegen für die Veröffentlichung noch nicht abgestimmt vor. Sobald sie freigegeben sind, werden sie hier ergänzt.',
    'story.quote.1': 'Ziel ist ein Brunnen im Dorf.',
    'story.quote.2': 'Er soll den Weg zu sauberem Wasser verkürzen.',
    'story.quote.3': 'Fortschritte und offene Punkte werden dokumentiert.',
    'story.signature': 'nach ihrer Reise nach Tansania',
    'story.cap.1': 'Eindruck aus Kisangasa.',
    'story.cap.2': 'Besuch vor Ort.',
    ...
    'help.people.consent': 'Die hier gezeigten Kinder und ihre Familien haben der Veröffentlichung von Foto und Vornamen ausdrücklich zugestimmt. Die Bilder wurden mit ihrem Einverständnis vor Ort aufgenommen.',
    ...
    'faq.q1': 'Sind meine Spenden steuerlich absetzbar?',
    'faq.a1': 'Nein. Da dieses Projekt eine private Spendeninitiative und kein eingetragener gemeinnütziger Verein ist, kann keine Zuwendungsbestätigung (Spendenquittung) ausgestellt werden. Wer eine steuerlich absetzbare Spende für Wasserprojekte in Tansania sucht, findet unter anderem bei Vision Tansania e.V., Tansania-Hilfe Erfurt e.V. oder Viva con Agua entsprechende Möglichkeiten.',
    'faq.q2': 'Hat der Brunnenbau schon begonnen?',
    'faq.a2': 'Nein. Aktuell läuft die Spendensammlung. Die Umsetzung beginnt erst nach gesicherter Finanzierung und Abstimmung vor Ort.',
    'faq.q3': 'Wer steht hinter der Spendensammlung?',
    'faq.a3': 'Edith Cielma unterstützt das Projekt und sammelt Spenden für den geplanten Brunnenbau in Kisangasa.',
    'faq.q4': 'Wofür wird das Geld verwendet?',
    'faq.a4': 'Die gesammelten Spenden sind zweckgebunden für den geplanten Brunnenbau und notwendige Schritte im Zusammenhang mit der Umsetzung vorgesehen.',
    'faq.q5': 'Wie kann ich spenden?',
    'faq.a5': 'Über den externen Spendenlink auf 4fund.',
    'faq.q6': 'Was passiert, wenn das Spendenziel erreicht ist?',
    'faq.a6': 'Dann werden die nächsten Schritte zur Umsetzung vorbereitet und transparent auf dieser Website dokumentiert.',
    'faq.q7': 'Was passiert, wenn mehr Geld gesammelt wird?',
    'faq.a7': 'Zusätzliche Mittel sollen ebenfalls zweckgebunden im Zusammenhang mit dem Brunnenprojekt oder notwendiger Unterstützung vor Ort verwendet werden.',
    'faq.q8': 'Wie wird der Fortschritt dokumentiert?',
    'faq.a8': 'Wir veröffentlichen mindestens alle 8 Wochen ein Update, spätestens bis 10.07.2026. Wenn es nichts Neues gibt, sagen wir auch das.',
    ...
    'transparency.a5': 'Mindestens alle 8 Wochen. Nächstes Update spätestens am 10.07.2026.',
  ...
  en: {
    ...
    'hero.next_update': 'Next update: July 10, 2026',
    'floating.donate': 'Donate',

    'story.eyebrow': 'The story',
    'story.title.1': 'Kisangasa needs',
    'story.title.2': 'a reliable water source.',
    'story.p1': 'Kisangasa is a village in Tanzania. Many families there do not have secure access to clean water nearby.',
    'story.p2': 'Verified figures on the number of residents and the exact distance to the nearest safe water source are still being checked with contacts on site. This information will be added once it is reliable.',
    'story.p3': 'The current need is clear: water has to be carried over long distances. This takes time, affects children and women in particular, and increases the risk of using contaminated water.',
    'story.p4': 'Direct quotes from residents of Kisangasa have not yet been cleared for publication. Once they are approved, they will be added here.',
    'story.quote.1': 'The goal is a well in the village.',
    'story.quote.2': 'It should shorten the way to clean water.',
    'story.quote.3': 'Progress and open points will be documented.',
    'story.signature': 'after her trip to Tanzania',
    'story.cap.1': 'Impression from Kisangasa.',
    'story.cap.2': 'Visit on site.',
    ...
    'help.people.consent': 'The children shown here and their families have explicitly agreed to the publication of their photo and first name. The images were taken on site with their consent.',
    'help.person.1.name': 'John',
    ...
    'faq.q1': 'Are my donations tax-deductible?',
    'faq.a1': 'No. This project is a private fundraising initiative and not a registered non-profit association, so no donation receipt can be issued. If you are looking for a tax-deductible donation for water projects in Tanzania, Vision Tansania e.V., Tansania-Hilfe Erfurt e.V. or Viva con Agua are among the possible options.',
    'faq.q2': 'Has construction already started?',
    'faq.a2': 'No. Fundraising is currently ongoing. Implementation starts only after secured funding and coordination on site.',
    'faq.q3': 'Who is behind the fundraising?',
    'faq.a3': 'Edith Cielma supports the project and collects donations for the planned well construction in Kisangasa.',
    'faq.q4': 'What will the money be used for?',
    'faq.a4': 'The collected donations are intended for the planned well construction and necessary steps connected with implementation.',
    'faq.q5': 'How can I donate?',
    'faq.a5': 'Via the external donation link on 4fund.',
    'faq.q6': 'What happens when the donation goal is reached?',
    'faq.a6': 'The next implementation steps will be prepared and documented transparently on this website.',
    'faq.q7': 'What happens if more money is collected?',
    'faq.a7': 'Additional funds should also be used for the well project or necessary support on site.',
    'faq.q8': 'How will progress be documented?',
    'faq.a8': 'We publish an update at least every 8 weeks, no later than July 10, 2026. If there is nothing new, we will say that too.',
    ...
    'transparency.a5': 'At least every 8 weeks. Next update no later than July 10, 2026.',
